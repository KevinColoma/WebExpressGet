...
// Calcular el IVA de un producto (IVA 12%)
...
// Productos más vendidos (requiere modelo Sales, sumariza ventas)
router.get('/products/most-sold', async (req, res) => {
  try {
    const Sales = require('../models/sales');
    // Aggregate pipeline para sumar cantidades vendidas por producto
